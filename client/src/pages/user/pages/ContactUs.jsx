            ...
            <div
                ...
                <div className=" text-neutral-content place-content-around">
                    <div className="lg:max-w-4xl max-2xl border-0 px-4 mt-[-50px]">
                        <h1 className="mb-5 lg:text-5xl text-[30px] font-samibold text-center">Contact Us</h1>
                        <p className='border-b-[1px] text-center leading-5 pb-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Debitis error aliquid voluptate ipsam ab suscipit iusto, eius voluptatem totam asperiores, pariatur maiores sunt possimus nam autem dolor vitae eum architecto!</p>
                        <div className="grid grid-cols-2 mt-4 leading-5 sm:px-2">
                            <div className=" sm:col-span-1 col-span-2 border-0 grid grid-cols-3 sm:h-[270px] mb-4">
                                <div className='sm:flex border-0 sm:my-0 py-0 col-span-1 sm:col-span-3 '>
                                    ...
                                    <div className="sm:ml-2 leading-4 mt-2 ">
                                        <p className='text-[14px] sm:text-[20px]'>Address : <br /><span className='text-[12px] sm:text-[13px]'>Lorem ipsum dolor lore Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit, sapiente. sit amet.</span></p>
                                    </div>
                                </div>
                                <div className='sm:flex border-0 sm:my-0 py-0 col-span-1 sm:col-span-3 '>
                                    <div className="w-[100px]">
                            ...
                            <div className=" sm:col-span-1 col-span-2 sm:mx-2">
                                <form className=' py-6 px-12 border-[1px] rounded-sm '>
                                    <div className="">
                                        <label htmlFor="name" className="block text-[15px] font-medium leading-6 text-slate-300">
                                            Name
                                        </label>
                                        <div className="mt-2">
                                            <input
                                    ...
                                    <div className="">
                                        <label htmlFor="email" className="block text-[15px] font-medium leading-6 text-slate-300">
                                            Email
                                        </label>
                                        <div className="mt-2">
                                            <input
                                    ...
                                    <div className="">
                                        <label htmlFor="message" className="block text-[15px] font-medium leading-6 text-slate-300">
                                            Message
                                        </label>
                                        <div className="mt-2">
                                            <textarea
