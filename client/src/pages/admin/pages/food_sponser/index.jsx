...
export default function FoodSponser() {
  ...
  const handleDeleteClick = (foodSponsorId) => {
    setSelectedFoodSponsorId(foodSponsorId);
    setShowConfirmation(true);
  };

  const handleConfirmDelete = async () => {
    try {
      await deleteFoodSpon(selectedFoodSponsorId);
      toast.success("Sponsor deleted successfully!");
      setShowConfirmation(false);
      getFoodData(); // Refresh the list after deletion
    } catch (error) {
