...
export default function SType() {
    ...
    const [showConfirmation, setShowConfirmation] = useState(false);  // Declare state for confirmation modal
    const [selectedSponserId, setSelectedSponserId] = useState(null);  // Declare state for selected sponsor
